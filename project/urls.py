...
from final_project.views import Home, Dashboard, CreateAccount, CreateCourse, EditInformation, AssignProfCourse, AssignTACourse, AllocateSections, AssignTASection, Error
urlpatterns = [
