...
class AllocateSectionTests(TestCase):
    ...
    def test_invalidTA(self):
        ...
        self.assertEqual(resp.context["message"], 'TA or lecture does not exist', msg="Invalid TA did not result in correct error message")
    ...
    def test_invalidLec(self):
        ...
        self.assertEqual(resp.context["message"], 'TA or lecture does not exist', msg="Invalid lec did not result in correct error message")
